...
const Depreciationlist: NextPage = () => {
    ...
    return (
        <div>
            <main className={styles.main}>
                <Card>
                    <Card.Header className="CardHeader" as="h5">ประเภทค่าเสื่อมราคา</Card.Header>
                    <Card.Body>
                        <Form>
                            <Row>
                                <Col>
                                        ...
                                        <Form noValidate validated={validated} onSubmit={handleSubmit}>
                                            <Row className="mb-3">
                                                <Form.Group as={Col} md="6" controlId="validationCustom05">
                                                    <Form.Label>ค้นหาประเภทค่าเสื่อมราคา</Form.Label>
                                                    <Form.Control
                                                        required
                                                        type="text"
                            ...
                            <Table size="sm" striped bordered hover>
                                <thead>
                                    <tr>
                                        ...
                                        <th style={{ textAlign: 'center' }}>ประเภทค่าเสื่อมราคา</th>
                                        <th style={{ textAlign: 'center' }}>อายุการใช้งาน (ปี)</th>
