...
import Addunitlist from '../../component/basicinfo/addunitlist';
    ...
    return (
        <div>
            <main className={styles.main}>
                <Card>
                    <Card.Header className="CardHeader" as="h5">หน่วยนับ</Card.Header>
                    <Card.Body>
                        <Form>
                            <Row>
                                <Col>
                                        ...
                                        <Form noValidate validated={validated} onSubmit={handleSubmit}>
                                            <Row className="mb-3">
                                                <Form.Group as={Col} md="6" controlId="validationCustom05">
                                                    <Form.Label>ค้นหาหน่วยนับ</Form.Label>
                                                    <Form.Control
                                                        required
                                                        type="text"
                            ...
                            <Table size="sm" striped bordered hover>
                                <thead>
                                    <tr>
                                        ...
                                        <th style={{ textAlign: 'center' }}>ชื่อหน่วยนับ</th>
