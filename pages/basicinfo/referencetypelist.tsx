...
import Addreferencetypelist from '../../component/basicinfo/addreferencetypelist';
registerLocale('th', th)



const Referencetypelist: NextPage = () => {
    ...
    return (
        <div>
            <main className={styles.main}>
                <Card>
                    <Card.Header className="CardHeader" as="h5">ประเภทอ้างอิง</Card.Header>
                    <Card.Body>
                        <Form>
                            <Row>
                                <Col>
                                        ...
                                        <Form noValidate validated={validated} onSubmit={handleSubmit}>
                                            <Row className="mb-3">
                                                <Form.Group as={Col} md="6" controlId="validationCustom05">
                                                    <Form.Label>ค้นหาประเภทอ้างอิง</Form.Label>
                                                    <Form.Control
                                                        required
                                                        type="text"
                                            ...
                                            <Row className="mb-3">
                                                ...
                                                <Col md="3">
                                                    <Button type="submit"><MdAssignment size="25px" title="Test" color="#fff" /> ออกรายงาน</Button>
                                                </Col>
                                            </Row>
                                        </Form>
                                    </div>
                            ...
                            <Table size="sm" striped bordered hover>
                                <thead>
                                    <tr>
                                        ...
                                        <th style={{ textAlign: 'center' }}>ชื่อประเภทอ้างอิง</th>
                                        <th style={{ textAlign: 'center' }}>ประเภทหักภาษี ณ ที่จ่าย</th>
