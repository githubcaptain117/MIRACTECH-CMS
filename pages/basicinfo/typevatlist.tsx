...
import Addtypevatlist from '../../component/basicinfo/addtypevatlist';
registerLocale('th', th)



const Typevatlist: NextPage = () => {
    ...
    return (
        <div>
            <main className={styles.main}>
                <Card>
                    <Card.Header className="CardHeader" as="h5">ค้นหาประเภทภาษีหัก ณ ที่จ่าย</Card.Header>
                    <Card.Body>
                        <Form>
                            <Row>
                                <Col>
                                        ...
                                        <Form noValidate validated={validated} onSubmit={handleSubmit}>
                                            <Row className="mb-3">
                                                <Form.Group as={Col} md="6" controlId="validationCustom05">
                                                    <Form.Label>ประเภทภาษีหัก ณ ที่จ่าย </Form.Label>
                                                    <br/>
                                                    <Form.Check
                                                        inline
                                                        label="บุคคล"
                                            ...
                                            <Row className="mb-3">
                                                <Form.Group as={Col} md="6" controlId="validationCustom05">
                                                    <Form.Label>ค้นหาชื่อประเภทภาษีหัก ณ ที่จ่าย</Form.Label>
                                                    <Form.Control
                                                        required
                                                        type="text"
                            ...
                            <Table size="sm" striped bordered hover>
                                <thead>
                                    <tr>
                                        ...
                                        <th style={{ textAlign: 'center' }}>ชื่อประเภทภาษีหัก ณ ที่จ่าย</th>
                                        <th style={{ textAlign: 'center' }}>อัตราภาษี</th>
                                        <th style={{ textAlign: 'center' }}>ประเภทภาษีหัก ณ ที่จ่าย</th>
