...
import Adddepreciationlist from '../../component/basicinfo/adddepreciationlist';
registerLocale('th', th)



const Parcelcategorylist: NextPage = () => {
    ...
    return (
        <div>
            <main className={styles.main}>
                <Card>
                    <Card.Header className="CardHeader" as="h5">หมวดพัสดุ</Card.Header>
                    <Card.Body>
                        <Form>
                            <Row>
                                <Col>
                                        ...
                                        <Form noValidate validated={validated} onSubmit={handleSubmit}>
                                            <Row className="mb-3">
                                                <Form.Group as={Col} md="6" controlId="validationCustom05">
                                                    <Form.Label>ค้นหาหมวดพัสดุ</Form.Label>
                                                    <Form.Control
                                                        required
                                                        type="text"
                            ...
                            <Table size="sm" striped bordered hover>
                                <thead>
                                    <tr>
                                        ...
                                        <th style={{ textAlign: 'center' }}>ชื่อหมวดพัสดุ</th>
...
export default Parcelcategorylist