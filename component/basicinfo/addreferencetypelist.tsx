...
const Addreferencetypelist: NextComponentType = () => {
                                            ...
                                            <div className={styles.frompopupinput}>
                                                <Form noValidate validated={validated} onSubmit={handleSubmit}>
                                                    <Row className="mb-3">
                                                        ...
                                                        <Form.Group as={Col} md="5" controlId="validationCustom01">
                                                            <Form.Label>ชื่อประเภทภาษีหัก ณ ที่จ่าย </Form.Label>
                                                            <Form.Control
                                                                required
                                                                type="text"
                                                                placeholder="กรอกข้อมูล....."
                                                    ...
                                                    <Row className="mb-3">
                                                        <Form.Group as={Col} md="5" controlId="validationCustom01">
                                                            <Form.Label>อัตราภาษี(ร้อยละ)</Form.Label>
                                                            <Form.Control
                                                                required
                                                                type="text"
                                                                placeholder="กรอกข้อมูล....."
...
export default Addreferencetypelist